...
(function () {
  ...
  var SUBJECTS = [
    { id: 'cs201', code: 'CS 201', name: 'Data Structures',  professor: 'Prof. Rahman' },
    { id: 'ma102', code: 'MA 102', name: 'Calculus II',      professor: 'Prof. Iyer' },
    { id: 'bi130', code: 'BI 130', name: 'Cell Biology',     professor: 'Prof. Okafor' },
    { id: 'ec220', code: 'EC 220', name: 'Microeconomics',   professor: 'Prof. Lindqvist' },
    { id: 'ps101', code: 'PS 101', name: 'Intro Psychology', professor: 'Prof. Navarro' }
  ];
